...
//                var areaName = message.Area.Name;
//                if (areaStats.Select(a => a.Area).Contains(areaName))
//                {
//                    foreach (var callsign in callsigns)
//                    {
//                        var linkId = $"callsign_{callsign}_area_{areaName}";
//                        var existingLink = flow.Links.FirstOrDefault(l =>
//                            l.SourceId == $"callsign_{callsign}" && l.TargetId == $"area_{areaName}" ||
//                            l.SourceId == $"area_{areaName}" && l.TargetId == $"callsign_{callsign}");
